...
export function CalendarEventForm({ alters, onSubmit }: CalendarEventFormProps) {
    ...
    <Dialog open={open} onOpenChange={v => { if (v) reset(); setOpen(v); }}>
      ...
      <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          ...
          <p className="text-sm text-muted-foreground">Plan ahead — set who should front, what support is needed, and recovery time.</p>
        </DialogHeader>
